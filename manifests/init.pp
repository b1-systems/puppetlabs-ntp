class ntp (
  ...
  $keysdir           = $ntp::params::keysdir,
  $package_ensure    = $ntp::params::package_ensure,
  $package_name      = $ntp::params::package_name,
  $panic             = $ntp::params::panic,
  $peers             = $ntp::params::peers,
  $peers_autokey     = $ntp::params::peers_autokey,
  $preferred_servers = $ntp::params::preferred_servers,
  $restrict          = $ntp::params::restrict,
  $servers           = $ntp::params::servers,
  $servers_autokey   = $ntp::params::servers_autokey,
  ...
  validate_string($keysdir)
  validate_string($package_ensure)
  validate_array($package_name)
  validate_bool($panic)
  validate_array($peers)
  validate_array($peers_autokey)
  validate_array($preferred_servers)
  validate_array($restrict)
  validate_array($servers)
  validate_array($servers_autokey)
